  ...
  return (
    <section id="services" className="max-w-[1200px] mx-auto px-8 md:px-16 py-28">
      <div className="mb-16">
        ...
        <h2 className="font-heading text-3xl md:text-[42px] tracking-wider mb-4 leading-snug text-[#1B263B]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Large feature card */}
        <div className="md:row-span-2 bg-gray-50 border border-gray-200 rounded-3xl overflow-hidden group hover:border-orange/50 transition-all">
          ...
          <div className="p-8 md:p-10">
            ...
            <h3 className="font-heading text-xl md:text-2xl tracking-wider mb-2 text-[#1B263B]">
              {features[0].title}
            </h3>
        ...
        {features.slice(1).map((feature) => (
          <div
            key={feature.title}
            className="bg-gray-50 border border-gray-200 rounded-3xl overflow-hidden group hover:border-orange/50 transition-all"
          >
            ...
            <div className="p-8">
              ...
              <h3 className="font-heading text-base tracking-wider mb-2 text-[#1B263B]">
                {feature.title}
              </h3>
